...
//   Kp_inner  ≈ 2.0 + (mass_g − 40) × 0.033
//   Kd_inner  ≈ Kp_inner × 0.008   (brushed)
//              ≈ Kp_inner × 0.009   (BLDC)
...
// Activate: uncomment this block and comment out PRESET B
...
#define PID_YAW_KD     0.00f    // Yaw D is always 0 on brushed — adds noise
...
// Activate: uncomment this block and comment out PRESET A
