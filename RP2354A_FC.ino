// ================================================================
// RP2354A Flight Controller  — Complete Flight Stack v4
// ================================================================
...
// Battery  : ADC0 voltage + ADC1 current
//
// ---- Core 0 -----------------------------------------------
...
void setup()
{
    ...
    // ---- PID -------------------------------------------------
    pidAxisInit(&pidRoll,  PID_ROLL_KP,  PID_ROLL_KI,  PID_ROLL_KD,
                PID_INTEGRAL_LIMIT, PID_OUTPUT_LIMIT);
    pidAxisInit(&pidPitch, PID_PITCH_KP, PID_PITCH_KI, PID_PITCH_KD,
                PID_INTEGRAL_LIMIT, PID_OUTPUT_LIMIT);
    pidAxisInit(&pidYaw,   PID_YAW_KP,   PID_YAW_KI,   PID_YAW_KD,
                PID_INTEGRAL_LIMIT, PID_OUTPUT_LIMIT);
...
void loop()
{
    ...
    else
    {
        ...
        m1Out = constrain(throttle + rollOut + pitchOut - yawOut, 0.0f, 1.0f);
        m2Out = constrain(throttle - rollOut - pitchOut - yawOut, 0.0f, 1.0f);
        m3Out = constrain(throttle - rollOut + pitchOut + yawOut, 0.0f, 1.0f);
        m4Out = constrain(throttle + rollOut - pitchOut + yawOut, 0.0f, 1.0f);
    }
    ...
    // ==============================================================
    // 13. Telemetry at 100 Hz (MSP + CSV)
    // ==============================================================
